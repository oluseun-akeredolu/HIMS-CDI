...
| Model | ECE | AUROC |
| :---- | --: | ----: |
| **Proposed (BBQ-calibrated)** | **0.0026** | **0.9796** (95% CI [0.9789, 0.9803]) |
| Uncalibrated Particle Filter | 0.0484 | 0.9998 |
| Logistic Regression | 0.0114 | 0.9959 |

BBQ calibration substantially reduces calibration error while incurring only a small reduction in AUROC because of bin-induced ties.

Results are reported exactly as obtained and are **not smoothed**.
